 ...
 */
void MarkerDetector::detect(const cv::Mat &input, std::vector<Marker> &detectedMarkers, cv::Mat camMatrix, cv::Mat distCoeff, float markerSizeMeters, bool setYPerperdicular)
{
    _impl->detect(input,detectedMarkers,camMatrix,distCoeff,markerSizeMeters,setYPerperdicular);
}
